...
- ⏭ Next: **Capacitor wrap** of the starter (needs a Mac/simulator) → **payments adapter** (blocked on Nurvana processor). TODO: `"native"` block in `manifest.schema.json`; per-capability + `$device` docs pages (task #12).
