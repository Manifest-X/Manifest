...
(function () {
    ...
    function report(area) {
        ...
        if (shape && !shape.collapsed) {
            area.style.setProperty('--text-edit-selection-x', px(shape.x));
            area.style.setProperty('--text-edit-selection-y', px(shape.y));
            area.style.setProperty('--text-edit-selection-width', px(shape.width));
            area.style.setProperty('--text-edit-selection-height', px(shape.height));
            area.style.setProperty('--text-edit-selection-center', px(shape.x + shape.width / 2));
        }
